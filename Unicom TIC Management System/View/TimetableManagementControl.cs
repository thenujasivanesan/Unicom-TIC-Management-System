...
namespace Unicom_TIC_Management_System.View
{
    public partial class TimetableManagementControl : UserControl
    {
        ...
        private void LoadTimetables()
        {
            ...
            dgvTimetable.Columns["Date"].DisplayIndex = 0; 
        ...
        private void dgvTimetable_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                dtpTimetable.Value = DateTime.Parse(row.Cells["Date"].Value.ToString());
            }
        }
        ...
        private void ClearFields()
        {
            ...
            txtTimeSlot.Text = "";
            dtpTimetable.Value = DateTime.Now;
        }
